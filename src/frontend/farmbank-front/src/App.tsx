  ...
  return (
    <Container sx={{
      ...
      <Box sx={{
        ...
        <TextField id="outlined-basic" label="Email" variant="outlined" size="small" sx={{minWidth: '300px'}} />
        <TextField id="outlined-basic" label="R$" variant="outlined" size="small" sx={{minWidth: '300px'}} />
        ...
        />
        <Button variant="outlined" color="secondary" endIcon={copied ? <CheckCircleOutline /> : null} onClick={() => handleCopyButton()}>
